...
namespace Moq.Sequencing.NavigationStrategies
{
  internal class NullSequenceNavigation : ICallSequenceNavigation
  {
    ...
    {
      throw NullSequenceException();
    }

    private MockException NullSequenceException()
    {
      return new NoSequenceAssignedException("No sequence set up for this mock. Please set up a valid sequence.");
    }
