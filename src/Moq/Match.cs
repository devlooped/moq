...
namespace Moq
{
	...
	///   completely replacing the built-in <see cref="It"/> class with your own argument matching rules.
	/// </summary>
	/// <remarks>See also <see cref="Match{T}"/>.</remarks>
	public abstract class Match : IMatcher
	{
		...
		/// </summary>
		/// <typeparam name="T">The type of value of match.</typeparam>
	...
	/// <remarks>
	///   The argument matching is used to determine whether a concrete invocation in the mock
