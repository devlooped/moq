...
namespace Moq.Tests 
{
	...
	{	
		...
		public void AnyMatcherShouldOnlyMatchIfTypesAreAssignable() {
			...
			mock.Expect(e => e.Execute(It.IsAny<Test1>())).Returns(1);
			mock.Expect(e => e.Execute(It.IsAny<Test2>())).Returns(2);
		...
		public void PredicateMatcherShouldOnlyMatchIfTheTypesAreAssignable() 
		{
			...
			mock.Expect(e => e.Execute(It.Is<Test1>(x => x.Property == 1))).Returns(1);
			mock.Expect(e => e.Execute(It.Is<Test2>(x => x.Property == 2))).Returns(2);
